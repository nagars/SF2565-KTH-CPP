...
#define M				1e5		// M value defined in assignment
#define THREADS_NUM		20		// Number of threads for parallel calc
#define WINDOWS_NUM		1000	// Number of windows to divide IC vec into
